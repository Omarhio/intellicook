...
const mockRecipes: Recipe[] = [
    {
        ...
        ingredients: [
            {
                ingredient: { id: 1, nom: 'Ingrédient 1' },
                quantite: 100,
                unite: 'g'
            }
        ],
    ...
    },
    {
        ...
        ingredients: [
            {
                ingredient: { id: 2, nom: 'Ingrédient 2' },
                quantite: 200,
                unite: 'g'
            }
        ],
    ...
    },
    {
        ...
        ingredients: [
            {
                ingredient: { id: 3, nom: 'Ingrédient 3' },
                quantite: 300,
                unite: 'g'
            }
        ],
...
describe('Carousel', () => {
    ...
    it('devrait changer l\'index lors du clic sur le bouton suivant', async () => {
        ...
        const nextButton = container.querySelector('button[aria-label="Recette suivante"]');
    ...
    it('devrait changer l\'index lors du clic sur le bouton précédent', async () => {
        ...
        const prevButton = container.querySelector('button[aria-label="Recette précédente"]');
